...
#define EXAMPLE_NETIF_DESC_STA "_netif_sta"
#endif
 ...
 */
esp_err_t smp_connect(void);

/**
 * Counterpart to smp_connect, de-initializes Wi-Fi or Ethernet
 */
esp_err_t smp_disconnect(void);
...
/**
 * @brief Returns esp-netif pointer created by smp_connect() described by
